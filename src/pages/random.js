  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(res => {
        ...
        return axios.get(
          `http://www.omdbapi.com/?t=${title}&y=${year}&apikey=95dd8229`
        )
      })
      .then(res => {
      ...
      <Nav.Link><Link to="/list/">Movie List</Link></Nav.Link>
        ...
        <Container className="mt-4">
          <Row>
            ...
            <Col></Col>
            <Col>
              {/* <h2 className="text-right">Random Movie</h2> */}
              {/* <hr></hr> */}
              ...
              <hr></hr>
              {/* <i><sub className="float-right">Warner pictures</sub></i> */}
