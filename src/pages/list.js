...
export default class List extends React.Component {
  ...
  getMovieList =  () => {
     axios
    .get(`https://random-movie-picker-kazan.herokuapp.com/availableMovies`)
    .then(res => {
    ...
    return (
      <div>
        <Header />
          ...
          <Row>
            {this.state.movieList.map(movie => <Col xs={6} md={2}>
      <Image src={movie.poster} rounded thumbnail fluid />
    </Col>)}
          </Row>
...
>
              ...
              <Row className="mt-4">
                { this.state.movie.hasBeenWatched ?  
                 ...
                 <Button className="btn-block" variant="success">Not Watched</Button>}</Row>
              <Row className="mt-2">
